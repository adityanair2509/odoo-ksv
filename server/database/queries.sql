...
-- Version 2.0 ΓÇö Updated to reflect schema v2 changes
...
-- Get pending approvals for a manager (direct rfq_id access ΓÇö no extra join needed)
SELECT
    a.*,
    q.grand_total,
    v.company_name,
...
-- WARNING: This deletes audit data ΓÇö use with caution

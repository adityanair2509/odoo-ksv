        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<AppLayout />}>
              ...
              <Route element={<RoleGuard roles={[ADMIN, PO]} />}>
              ...
              <Route element={<RoleGuard roles={[PO, ADMIN]} />}>
              ...
              {/* ── Purchase Orders & Invoices (Admin + PO + Vendor) ──────── */}
              <Route element={<RoleGuard roles={[ADMIN, PO, VENDOR]} />}>
